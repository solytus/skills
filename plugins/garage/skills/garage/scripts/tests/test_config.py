...
class TestConfig(unittest.TestCase):
    ...
    def test_data_root_env_wins(self):
        ...
        self.assertEqual(str(cfgmod.resolve_data_root(p, env={"GARAGE_DATA_ROOT": "/from/env"})), "/from/env")
    ...
    def test_tenant_env_wins(self):
        ...
        self.assertEqual(cfgmod.resolve_tenant_id(p, env={"GARAGE_TENANT_ID": "fromenv"}), "fromenv")
